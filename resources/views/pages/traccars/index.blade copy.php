    ...
    <div class="row mt-3">
        <div class="col-xl-2 col-md-6 col-xs-6 col-sm-6 mb-4">
          ...
          <div class="col-xl-2 col-md-6 col-xs-6 col-sm-6mb-4">
            <a href="/traccar/mati" class="text-white">
          ...
          <div class="col-xl-2 col-md-6 col-xs-6 col-sm-6 mb-4">
            <a href="/traccar/bergerak" class="text-white">
          ...
          <div class="col-xl-2 col-md-6 col-xs-6 col-sm-6 mb-4">
            <a href="/traccar/berhenti" class="text-white">
          ...
          <div class="col-xl-2 col-md-6 col-xs-6 col-sm-6 mb-4">
            <a href="/traccar/diam" class="text-white">
...
<script>
    ...
    geofences.forEach(function(geofence) {
        // Check if geofence type is 1 (radius type)
        if (geofence.type == 1) {
            // Extract latitude and longitude from the latlong field
            var [lat, lng] = geofence.latlong.split(',').map(coord => parseFloat(coord.trim()));

            // Create a circle using Leaflet's L.circle
            var circle = L.circle([lat, lng], {
                color: 'red',
                radius: geofence.radius // Set radius from the radius field
            }).addTo(mymap);

            // Add a click event to display information
            circle.on('click', function(e) {
                var info = "<b>Nama:</b> " + geofence.name;
                L.popup()
                    .setLatLng(e.latlng)
                    .setContent(info)
                    .openOn(mymap);
            ...
            var coordinates = geofence.latlong.replace('(', '').replace(')', '');
    ...
    $(document).ready(function () {
        ...
        function updateVehicleCounts(response) {
            ...
            //$('#total-inova-track').text('InovaTrack ' + response.totalInovaTrack);
        }
            ...
            return `
                <div>
                    ...
                    <ul>
                        ...
                        <li>Total Jarak: ${formattedDistance} Km</li>
